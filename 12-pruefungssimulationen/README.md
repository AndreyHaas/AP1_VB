...
praxisbezogene, ungebundene Aufgaben
Rechenweg und Einheiten vollständig angeben
Begründungen in vollständigen deutschen Sätzen formulieren
erst nach Abgabe mit Lösungen vergleichen
```

Aufgaben dürfen die Lösung nicht bereits durch überdeutliche Hinweise enthalten. Jede Simulation verbindet mehrere Bereiche, zum Beispiel Kundenbedarf, Hardwareauswahl, Netzwerk, Datenschutz, Qualität und Dokumentation.

## Dateien

| Simulation | Aufgaben | Getrennte Lösung | Schwerpunkt |
|---|---|---|---|
...
1. Aufgabenblatt lokal öffnen oder ausdrucken; Lösungsdatei geschlossen lassen.
2. 90 Minuten mit sichtbarer Uhr arbeiten.
3. Alle Antworten auf Deutsch formulieren und Rechenwege notieren.
4. Nach Ablauf sofort abgeben, auch wenn Teilaufgaben offen sind.
5. Mit der getrennten Lösung auf 100 Punkte korrigieren.
6. Fehler als `Wissen`, `Anwendung`, `Rechnen`, `Sprache` oder `Zeit` markieren.
7. Nur die fehlerhaften Teilaufgaben nach 24 bis 48 Stunden erneut lösen.

## Quellenrahmen

- [§ 9 FIAusbV](https://www.gesetze-im-internet.de/fiausbv/__9.html): praxisbezogene schriftliche Aufgaben, Prüfungszeit 90 Minuten und fünf nachzuweisende Handlungsbereiche.
