...
Все 52 главы существуют как пары RU/DE. Повторный аудит v1.7 дополнительно закрыл QR/RFID/NFC, Webgrundlagen, выбор Programmiersprache, SWOT/Marktforschung, Ishikawa/6-W, MDM/сетевую печать и сопоставление ITSM-Rahmenwerke. Созданы общий `FACHBEGRIFFE-DE-RU.md`, анализ переноса типов старых задач и короткий контрольный блок остаточных тем. Оставшиеся материалы вне пар служат организационными документами, неизменёнными оригиналами или изолированным AP2-Zusatzwissen.
...
8. Перед ними решить 30-минутный `kontrollblock-03-restthemen.md`; результат ниже 32/40 превращает соответствующие главы в личный приоритет.
